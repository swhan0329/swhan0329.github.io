...
const translations = {
    en: {
        ...
        'ecosystem.latest.onboarding.desc': 'The 2026.07.19 PDF guide to the ChatGPT–Codex switcher, new Codex sidebar, Quick chat, file permissions, and practical onboarding workflows.',
        ...
        'ebook.desc': 'A practical guide for connecting Codex to real work. The 2026.07.19 edition covers the ChatGPT–Codex global switcher, the new Codex sidebar, Quick chat, file permissions, and repeatable workflows.',
        ...
        'ebook.preview.item1': 'Understand the ChatGPT–Codex global switcher',
        'ebook.preview.item2': 'Explore the new Codex sidebar from New chat through Chats',
        'ebook.preview.item3': 'Use Quick chat and review file-permission cautions',
        ...
        'ebook.meta.version': '2026.07.19 · GPT-5.6 updated edition',
        'ebook.meta.formatLabel': 'Format',
        'ebook.meta.format': 'PDF · 71 pages',
        'ebook.meta.updateLabel': 'Update',
        'ebook.meta.update': '2026.07.19 content refresh',
        ...
        'ebook.home.codex.point1': 'The new global switcher between ChatGPT and Codex',
        'ebook.home.codex.point2': 'The new Codex sidebar and Quick chat panel',
        'ebook.home.codex.point3': 'Delegate real work while checking file permissions',
        ...
        'arrow.deadline': 'Available until July 31, 2026 at 11:59 PM KST',
    ...
    ko: {
        ...
        'ecosystem.latest.onboarding.desc': 'ChatGPT↔Codex 전환 메뉴, 새 Codex 사이드바, Quick chat, 파일 권한과 실전 온보딩 흐름을 반영한 2026.07.19 PDF입니다.',
        'ecosystem.latest.workflowShowTell.kicker': 'Workflow Show & Tell Seoul',
        ...
        'ebook.desc': 'Codex를 처음 업무에 연결하는 사람을 위한 실전 가이드입니다. 2026.07.19 업데이트판에는 ChatGPT↔Codex 전역 전환 메뉴, 새 Codex 사이드바, Quick chat, 파일 권한과 반복 가능한 업무 흐름을 반영했습니다.',
        'ebook.readingNote': 'AI에게 이 책을 요약하게 하지 마세요. 직접 1-2시간 시간을 내서 읽으세요. 그만한 가치가 있습니다.',
        'ebook.previewTitle': '담긴 내용 · 목차',
        'ebook.preview.item1': 'ChatGPT와 Codex 전역 전환 메뉴 이해하기',
        'ebook.preview.item2': 'New chat부터 Chats까지 새 Codex 사이드바 살펴보기',
        'ebook.preview.item3': 'Quick chat 패널과 파일 권한 주의사항',
        ...
        'ebook.meta.version': '2026.07.19 · GPT-5.6 업데이트판',
        'ebook.meta.formatLabel': '형식',
        'ebook.meta.format': 'PDF · 71 pages',
        'ebook.meta.updateLabel': '업데이트',
        'ebook.meta.update': '2026.07.19 콘텐츠 개정',
        ...
        'ebook.home.codex.point1': 'ChatGPT와 Codex를 오가는 새 전환 메뉴',
        'ebook.home.codex.point2': '새 Codex 사이드바와 Quick chat 패널',
        'ebook.home.codex.point3': '파일 권한을 확인하며 실제 업무 맡기기',
        ...
        'arrow.cta': '판매 페이지 보기',
        'arrow.deadline': '판매 기간 · 2026년 7월 31일 오후 11:59까지',
        'arrow.closed': '판매 종료',
