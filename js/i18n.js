...
const translations = {
    en: {
        ...
        'ecosystem.latest.workshop.title': 'Round 1 recap and event page',
        'ecosystem.latest.workshop.desc': 'A public recap of the first workshop, with the event page kept in the Events archive below.',
        ...
        'ebook.price': 'Free · $0',
        'ebook.title': 'Delegate Your Work to Codex',
        'ebook.desc': 'This is not a quick prompt collection. It is a practical guide for understanding Codex as a work environment, preparing context, giving better instructions, reviewing outputs, and building repeatable workflows around your own work.',
        ...
        'ebook.preview.item1': 'Understand Codex as a work environment, not just a chat window',
        'ebook.preview.item2': 'The basic loop: provide context, give instructions, review results, request edits',
        'ebook.preview.item3': 'Practical examples for safely delegating repeatable work',
        'ebook.preview.item4': 'How to tell the difference between weak instructions and useful instructions',
        'ebook.preview.item5': 'How to review outputs, give feedback, and hand the next iteration back to Codex',
        'ebook.preview.item6': 'How to build Codex usage patterns around your own work',
        'ebook.preview.item7': 'Examples across documents, research, email, and code work',
        'ebook.preview.item8': 'A first 1-2 hour reading and practice routine',
        'ebook.meta.versionLabel': 'Version',
        'ebook.meta.version': '2026.06.24',
        'ebook.meta.formatLabel': 'Format',
        'ebook.meta.format': 'PDF · 13.7 MB',
        'ebook.meta.updateLabel': 'Update',
        'ebook.meta.update': 'Drive file versioned',
        ...
        'ebook.note': 'The download button keeps working when this same Drive file is updated with a new version.',
        'ebook.home.title': 'Free E-books',
        'ebook.home.desc': 'Practical PDF resources you can read and use right away, from connecting Codex to real work to understanding IT, software, and startup terms before vibe coding with AI.',
        'ebook.home.codex.point1': 'Understand Codex as a work environment, not just a chat window',
        'ebook.home.codex.point2': 'The basic loop: provide context, give instructions, review results, request edits',
        'ebook.home.codex.point3': 'Examples across documents, research, email, and code work',
        ...
        'ebooks.desc': 'A library of PDF guides and practical resources for connecting Codex, AI, Developer Experience, and software vocabulary to real work.',
        'ebooks.portfolioCta': 'Portfolio section',
        'ebooks.detailCta': 'View details',
        'pangyo.label': 'Free PDF',
        'pangyo.price': 'Free · $0',
        'pangyo.title': 'Pangyo Dictionary',
        'pangyo.desc': 'A lightweight Korean glossary of 240 practical IT, software development, AI, and startup terms for people who want to vibe code with AI and collaborate with developers and planners.',
    ...
    ko: {
        ...
        'ecosystem.latest.workshop.kicker': 'Codex Impact Workshop',
        'ecosystem.latest.workshop.title': '1회차 결과 공유 글과 행사 페이지',
        'ecosystem.latest.workshop.desc': '첫 워크숍을 마친 뒤 남긴 LinkedIn 결과 공유 글과 행사 페이지를 함께 볼 수 있도록 정리했습니다.',
        ...
        'ebook.label': '무료 PDF',
        'ebook.price': '0원 무료',
        'ebook.title': 'Codex로 내 업무 맡기기',
        'ebook.desc': '이 책은 프롬프트 모음집이 아닙니다. Codex를 하나의 업무 환경으로 이해하고, 맥락을 준비하고, 더 나은 지시를 내리고, 결과를 검토하고, 내 업무에 맞는 반복 가능한 워크플로우를 만드는 방법을 정리한 실전 가이드입니다.',
        'ebook.readingNote': 'AI에게 이 책을 요약하게 하지 마세요. 직접 1-2시간 시간을 내서 읽으세요. 그만한 가치가 있습니다.',
        'ebook.previewTitle': '담긴 내용 · 목차',
        'ebook.preview.item1': 'Codex를 채팅창이 아니라 업무 환경으로 이해하기',
        'ebook.preview.item2': '자료 제공, 지시, 결과 확인, 수정 요청의 기본 루프',
        'ebook.preview.item3': '반복 업무를 안전하게 맡기기 위한 실전 예시',
        'ebook.preview.item4': '좋은 지시와 나쁜 지시를 가르는 기준',
        'ebook.preview.item5': '결과물을 검토하고 피드백한 뒤 다시 맡기는 방법',
        'ebook.preview.item6': '내 업무에 맞는 Codex 사용 패턴 만들기',
        'ebook.preview.item7': '문서, 리서치, 메일, 코드 작업에 적용하는 예시',
        'ebook.preview.item8': '처음 1-2시간을 어떻게 읽고 실습할지에 대한 루틴',
        'ebook.meta.versionLabel': '버전',
        'ebook.meta.version': '2026.06.24',
        'ebook.meta.formatLabel': '형식',
        'ebook.meta.format': 'PDF · 13.7 MB',
        'ebook.meta.updateLabel': '업데이트',
        'ebook.meta.update': 'Drive 파일 버전 관리',
        'ebook.downloadCountLabel': '다운로드',
        'ebook.downloadCountUnavailable': '집계 준비 중',
        'ebook.download': 'PDF 다운로드',
        'ebook.all': '전체 e-book 보기',
        'ebook.note': '같은 Drive 파일에서 새 버전을 업로드하면 이 다운로드 버튼은 그대로 최신본을 내려받습니다.',
        'ebook.home.title': '무료 E-books',
        'ebook.home.desc': 'Codex를 업무에 붙이는 방법부터 AI 바이브코딩 협업 전에 알아두면 좋은 IT·개발·스타트업 용어까지, 바로 읽고 써먹을 수 있는 PDF 자료를 모았습니다.',
        'ebook.home.codex.point1': 'Codex를 채팅창이 아니라 업무 환경으로 이해하기',
        'ebook.home.codex.point2': '자료 제공, 지시, 결과 확인, 수정 요청의 기본 루프',
        'ebook.home.codex.point3': '문서, 리서치, 메일, 코드 작업에 적용하는 예시',
        'ebook.related.pangyo.title': '판교어 사전',
        'ebook.related.pangyo.desc': 'AI 바이브코딩 협업 전에 보는 IT · 개발 · 스타트업 용어 240',
        'ebooks.label': '자료실',
        'ebooks.title': 'E-books',
        'ebooks.desc': 'Codex, AI, Developer Experience와 IT·개발·스타트업 용어를 실제 업무에 연결하기 위해 만든 PDF 가이드와 실전 자료를 모았습니다.',
        'ebooks.portfolioCta': '포트폴리오 섹션',
        'ebooks.detailCta': '상세 보기',
        'pangyo.label': '무료 PDF',
        'pangyo.price': '0원 무료',
        'pangyo.title': '판교어 사전',
        'pangyo.desc': 'AI로 바이브코딩하고 개발자·기획자·스타트업 사람들과 대화할 때 자주 만나는 IT 실전 용어 240개를 가볍게 훑는 PDF 사전입니다.',
