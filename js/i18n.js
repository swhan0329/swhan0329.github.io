...
const translations = {
    en: {
        ...
        'projects.techabreak.desc': 'An interview-based newsletter about how people are living through the AI transition. I started it to document human stories and emotions around change, not just tactical advice on how to use AI better.',
    ...
    ko: {
        ...
        'projects.techabreak.title': 'Tech a Break',
        'projects.techabreak.desc': 'AI를 “더 잘 쓰는 방법”보다, 그 변화를 살아가는 사람들의 경험과 감정을 인터뷰로 기록하는 뉴스레터입니다. 천천히, 하지만 오래 남는 이야기를 남기고 싶어 시작했습니다.',
