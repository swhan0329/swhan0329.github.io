...
const translations = {
    en: {
        ...
        'ebook.preview.item1': 'Install on Mac or Windows and continue work on mobile',
        'ebook.preview.item2': 'Learn first requests, settings, permissions, and result screens',
        'ebook.preview.item3': 'Use plugins and practical prompts for real work',
        ...
        'ebook.preview.item6': 'Systematize repetitive work with skills and automations',
        'ebook.preview.item7': 'Explore Remote, Browser, Sites, and Computer Use',
        ...
        'ebook.meta.version': '2026.07.10',
        'ebook.meta.formatLabel': 'Format',
        'ebook.meta.format': 'PDF · 71 pages',
    ...
    ko: {
        ...
        'ebook.preview.item1': 'Mac·Windows 설치와 모바일에서 작업 이어보기',
        'ebook.preview.item2': '첫 요청, 설정, 권한과 결과 화면 익히기',
        'ebook.preview.item3': '플러그인과 실제 업무용 프롬프트',
        'ebook.preview.item4': 'AGENTS.md와 메모리로 작업 원칙 남기기',
        'ebook.preview.item5': '/plan, /goal, /side, /fork로 긴 작업 운영하기',
        'ebook.preview.item6': '스킬과 자동화로 반복 업무 시스템화하기',
        'ebook.preview.item7': 'Remote, Browser, Sites, Computer Use 살펴보기',
