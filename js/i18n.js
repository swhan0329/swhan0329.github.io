...
const translations = {
    en: {
        ...
        'talks.mcp.title': "When AI Agents Need Eyes",
        'talks.mcp.subtitle': "MCP Dev Summit Seoul 2026 · What MCP Can and Cannot Standardize for Computer Vision",
        'talks.mcp.desc': "A talk on connecting AI agents with vision tools through MCP, drawing on production computer vision experience and labeling review experiments. Covered model failures, business context, and interface issues, and where domain-specific design and human review remain necessary.",
        ...
        'ecosystem.latest.label': 'Latest posts',
        'ecosystem.latest.date': 'September 2026',
        'ecosystem.latest.drone.kicker': "2026.09.08 · Computer Vision",
        'ecosystem.latest.drone.title': "A drone simulator from a single warehouse photo",
        'ecosystem.latest.drone.desc': "Built a web simulation with Astra from one warehouse photo: estimated relative depth, reconstructed a colored point cloud, and visualized a drone following waypoints with RGB and depth views.",
        'ecosystem.link.droneSimulator': "2026.09.08 A drone simulator from a single warehouse photo",
        'ecosystem.link.guideFifthEdition': "2026.09.07 ChatGPT App guide - Fifth Revised Edition",
        'ecosystem.latest.impact2.kicker': "2026.09.08 · Codex Impact Workshop #2",
        'ecosystem.latest.impact2.title': "Building MVPs for social problems with AI·SW MAESTRO",
        'ecosystem.latest.impact2.desc': "Co-organized the second workshop with AI·SW MAESTRO's 17th cohort. Ten teams built and presented working MVPs for social problems with Codex in 2.5 hours.",
        'ecosystem.link.codexImpact2Recap': "2026.09.08 Codex Impact Workshop #2 recap",
        'ecosystem.event.codexImpactWorkshop2': "2026.09.04 Codex Impact Workshop #2 with AI·SW MAESTRO (Co-organizer)",
        ...
        'ecosystem.latest.onboarding.kicker': '2026.09.07 · ChatGPT App guide',
    ...
    ko: {
        ...
        'nav.talks': '발표',
        'talks.title': '초청 발표',
        'talks.mcp.title': "AI Agent에게 눈이 필요할 때",
        'talks.mcp.subtitle': "MCP Dev Summit Seoul 2026 · MCP가 Computer Vision에서 표준화할 수 있는 것과 없는 것",
        'talks.mcp.desc': "실제 Computer Vision 운영 경험과 레이블 검수 실험을 바탕으로, MCP로 AI Agent와 Vision Tool을 연결하는 방법을 발표했습니다. 모델·업무 맥락·인터페이스의 실패를 구분하고, 도메인별 설계와 사람의 검토가 필요한 범위를 다뤘습니다.",
        ...
        'ecosystem.latest.label': '최근 공개 작업 · 최신 글 순',
        'ecosystem.latest.date': '2026년 9월',
        'ecosystem.latest.drone.kicker': "2026.09.08 · Computer Vision",
        'ecosystem.latest.drone.title': "창고 사진 한 장으로 만든 드론 웹 시뮬레이터",
        'ecosystem.latest.drone.desc': "Astra에 창고 사진 한 장을 올려 상대 깊이를 추정하고 RGB 포인트 클라우드로 재구성했습니다. 드론의 경로 비행과 가상 카메라의 RGB·Depth 화면을 웹에서 조작할 수 있게 만들었습니다.",
        'ecosystem.link.droneSimulator': "2026.09.08 창고 사진 한 장으로 만든 드론 웹 시뮬레이터",
        'ecosystem.link.guideFifthEdition': "2026.09.07 ChatGPT App으로 내 업무 맡기기 제5차 개정판",
        'ecosystem.latest.impact2.kicker': "2026.09.08 · Codex Impact Workshop #2",
        'ecosystem.latest.impact2.title': "AI·SW마에스트로와 함께한 사회문제 해결 MVP 만들기",
        'ecosystem.latest.impact2.desc': "AI·SW마에스트로 17기 연수생들과 두 번째 워크숍을 공동 기획·운영했습니다. 10개 팀이 2시간 반 동안 Codex로 사회문제 해결 MVP를 구현하고 발표했습니다.",
        'ecosystem.link.codexImpact2Recap': "2026.09.08 Codex Impact Workshop #2 후기",
        'ecosystem.event.codexImpactWorkshop2': "2026.09.04 AI·SW마에스트로 Codex Impact Workshop #2 공동 기획·운영",
        'ecosystem.latest.roboflow.kicker': 'Roboflow MCP',
        ...
        'ecosystem.latest.onboarding.kicker': '2026.09.07 · ChatGPT App 가이드',
