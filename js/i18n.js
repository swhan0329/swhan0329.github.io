...
const translations = {
    en: {
        ...
        'ebooks.desc': 'A library of PDF guides and practical resources for connecting Codex, AI, and Developer Experience to real work.',
    ...
    ko: {
        ...
        'ebooks.label': '자료실',
        'ebooks.title': 'E-books',
        'ebooks.desc': 'Codex, AI, Developer Experience를 실제 업무에 연결하기 위해 만든 PDF 가이드와 실전 자료를 모았습니다.',
