...
const translations = {
    en: {
        ...
        'hero.title': 'Developer Experience & AI Engineer',
        'hero.education': 'Ph.D. Candidate, Korea University CS | CMU AI Program (Full Scholarship by IITP, Korea)',
        'hero.description': 'I build developer workflows and practical learning resources around Codex, LLMs, multimodal AI, and AI-native applications. As an OpenAI Codex Ambassador, I create bilingual Korean/English technical content, demos, workshops, and feedback loops that help developers turn frontier AI into real products.',
        ...
        'about.intro': 'I\'m a <strong>Developer Experience & AI Engineer</strong>. I build practical AI systems, developer workflows, and learning resources that help people turn new AI capabilities into useful products.',
        ...
        'projects.orderIntro': 'Ordered by DevX fit: Codex demo first, then recent AI architecture, agent/client workflows, production impact work, and older archived experiments.',
        ...
        'ecosystem.ambassador.desc': 'Helping Korean developers adopt Codex and frontier AI through practical guides, demos, workshops, and structured feedback loops.',
    ...
    ko: {
        ...
        'hero.description': 'Codex, LLM, 멀티모달 AI, AI-native 애플리케이션을 중심으로 개발자 워크플로우와 실전 학습 자료를 만듭니다. OpenAI Codex Ambassador로서 한/영 기술 콘텐츠, 데모, 워크숍, 피드백 루프를 만들며 개발자들이 frontier AI를 실제 제품으로 연결하도록 돕습니다.',
        'hero.cta': '연락하기',
        ...
        // About
        'about.title': '소개',
        'about.intro': '저는 <strong>개발자 경험 & AI 엔지니어</strong>입니다. 실전 AI 시스템, 개발자 워크플로우, 학습 자료를 만들어 새로운 AI 역량이 실제 제품으로 이어지도록 돕습니다.',
        ...
        'projects.orderIntro': 'DevX 적합도가 높은 순서로 배치했습니다: Codex 데모 → 최근 AI 아키텍처 → agent/client 워크플로우 → 프로덕션 임팩트 작업 → 오래된 실험 아카이브.',
        ...
        'ecosystem.ambassador.desc': '실전 가이드, 데모, 워크숍, 구조화된 피드백 루프를 통해 한국 개발자들이 Codex와 frontier AI를 더 쉽게 채택하도록 돕고 있습니다.',
